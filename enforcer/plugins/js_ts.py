...
class Plugin:
    ...
    def lint(self, files, disabled_rules, tool_configs=None):
        ...
        if result.returncode != 0 and not result.stdout.strip():
             errors.append({"tool": "eslint", "file": "config", "line": 0, "message": result.stderr})
        ...
        try:
            ...
            errors.append({"tool": "eslint", "file": "parser", "line": 0, "message": "Failed to parse ESLint JSON output."})
